...
# elenco
curl -s -H "Authorization: Bearer $TOK" "$BASE/api/v1/deployments?profile=myteam"

# crea
curl -s -X POST -H "Authorization: Bearer $TOK" -H 'Content-Type: application/json' \
  -d '{"profile":"myteam","modello":"deepseek/deepseek-chat","endpoint":"https://openrouter.ai/api/v1","data":"free","key":"sk-or-…","context":200}' \
