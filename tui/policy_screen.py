...
SCALAR_ROWS: list[tuple[str, str, str, str]] = [
    ...
    ("Warm", "session_dep_guard.sec",
     "Durata warm / anti-usurpazione (s)", "int"),
    ("Warm", "warm_pool.ttl_sec",
     "TTL pool caldi (0 = segue la guardia)", "int"),
    ("Warm", "stream_slow_race_after_ms",
     "Gara lenta: soglia streaming (ms, 0=off)", "int"),
    ("Warm", "nonstream_slow_race_after_ms",
     "Gara lenta: soglia non-stream (ms, 0=off)", "int"),
    ("Warm", "stream_slow_race_canaries",
     "Gara lenta: canary aperti", "int"),
